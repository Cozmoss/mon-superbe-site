...
<form action="" method="post">
	<div class="form-group">
		...
		<input type="text" name="ht" class='form-control' value="<?= isset($_POST["ht"])
  	? htmlspecialchars($_POST["ht"])
  	: "" ?>">
	</div>
	<div class="form-group">
		<label for="tva">Taux de TVA (en %)</label>
		<input type="number" name="tva" class='form-control' value="<?= isset(
  	$_POST["tva"],
  )
  	? htmlspecialchars($_POST["tva"])
  	: "" ?>">
	</div>
	...
	<?php if (isset($_POST["submit"])) {
 	$ht = floatval(
 		str_replace(",", ".", htmlspecialchars(trim($_POST["ht"]))),
 	);
